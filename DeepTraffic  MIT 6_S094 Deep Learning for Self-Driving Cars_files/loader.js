    ...
    function(e) {
        ...
        var p = function() {
            ...
            return e.prototype._digestDependencies = function() {
                ...
                var t, n, o;
                for (t = 0, n = this._dependencies.length; t < n; t++) if (o = this._dependencies[t]) if ("exports" === o) this._exportsPassedIn = !0, this._normalizedDependencies[t] = o, this._dependenciesValues[t] = this._exports, this._unresolvedDependenciesCount--;
        ...
        var y = function() {
            ...
            return e._findRelevantLocationInStack = function(e, t) {
                ...
                for (var o, r = this._dependencies[e], i = 0, s = r.length; i < s; i++) if (o = this._findCyclePath(r[i], t, n + 1), null !== o) return o.push(e), o;
                return null
