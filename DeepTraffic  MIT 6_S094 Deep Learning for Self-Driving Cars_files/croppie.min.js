!
    function (e, t) {
        ...
        function t(e) {
            if (e in q) return e;
            for (var t = e[0].toUpperCase() + e.slice(1), n = T.length; n--;) if (e = T[n] + t, e in q) return e
        }
        function n(e, t) {
            e = e || {};
        ...
        function u(e, t, n) {
            ...
            return i.style.opacity = 0,
                new Promise(function (t) {
                    ...
                    return i.src === e ? void o() : (i.exifdata = null, i.removeAttribute("crossOrigin"), e.match(/^https?:\/\/|^\/\//) && i.setAttribute("crossOrigin", "anonymous"), i.onload = function () {
        ...
        function d() {
            var e, t, n, i, o, s, l = this,
                u = "croppie-container",
                c = l.options.viewport.type ? "cr-vp-" + l.options.viewport.type : null;
            l.options.useCanvas = l.options.enableOrientation || m.call(l),
                ...
                l.options.useCanvas ? (l.elements.canvas = document.createElement("canvas"), l.elements.preview = l.elements.canvas) : l.elements.preview = l.elements.img,
                a(e, "cr-boundary"),
        ...
        function f() {
            function e(e) {
                if ((void 0 === e.button || 0 === e.button) && (e.preventDefault(), !m)) {
                    ...
                    if (m = !0, o = e.pageX, s = e.pageY, i = -1 !== e.currentTarget.className.indexOf("vertical") ? "v" : "h", l = r.width, u = r.height, e.touches) {
                        var a = e.touches[0];
                        o = a.pageX,
                            s = a.pageY
                    }
            ...
            function t(e) {
                ...
                "v" === i && m >= f && u >= m ? (r(d, {
                    height: m + "px"
                }), p.options.boundary.height += h, r(p.elements.boundary, {
                    height: p.options.boundary.height + "px"
                }), p.options.viewport.height += h, r(p.elements.viewport, {
                    height: p.options.viewport.height + "px"
                })) : "h" === i && v >= f && l >= v && (r(d, {
                    width: v + "px"
                }), p.options.boundary.width += c, r(p.elements.boundary, {
                    width: p.options.boundary.width + "px"
                }), p.options.viewport.width += c, r(p.elements.viewport, {
            ...
            this.options.resizeControls.height && (c = document.createElement("div"), a(c, "cr-resizer-vertical"), d.appendChild(c)),
            this.options.resizeControls.width && (h = document.createElement("div"), a(h, "cr-resizer-horisontal"), d.appendChild(h)),
        ...
        function g() {
            ...
            n.options.mouseWheelZoom && (n.elements.boundary.addEventListener("mousewheel", t), n.elements.boundary.addEventListener("DOMMouseScroll", t))
        }
        function w(e) {
            function t() {
                var e = {};
        ...
        function x() {
            ...
            function t(e) {
                ...
                if (!e.shiftKey || e.keyCode != o && e.keyCode != a) {
                    if (d.options.enableKeyMovement && e.keyCode >= 37 && e.keyCode <= 40) {
                        e.preventDefault();
                        var s = t(e.keyCode);
                    ...
                    var l = 0;
                    l = e.keyCode == o ? parseFloat(d.elements.zoomer.value, 10) + parseFloat(d.elements.zoomer.step, 10) : parseFloat(d.elements.zoomer.value, 10) - parseFloat(d.elements.zoomer.step, 10),
                        d.setZoom(l)
                }
            }
            function n(t) {
            ...
            function a(t) {
                ...
                if ("touchmove" == t.type && t.touches.length > 1) {
                    var f = t.touches[0],
                        g = t.touches[1],
                        w = Math.sqrt((f.pageX - g.pageX) * (f.pageX - g.pageX) + (f.pageY - g.pageY) * (f.pageY - g.pageY));
                    c || (c = w / d._currentZoom);
                    var y = w / c;
                    return v.call(d, y),
                        void o(d.elements.zoomer)
                }
                e(s, h),
                    m[A] = p.toString(),
        ...
        function E() {
            var e, t = this,
                n = t.get();
            if (_.call(t)) if (t.options.update.call(t, n), t.$ && "undefined" == typeof Prototype) t.$(t.element).trigger("update", n);
            else {
                var e;
                window.CustomEvent ? e = new CustomEvent("update", {
                    detail: n
                }) : (e = document.createEvent("CustomEvent"), e.initCustomEvent("update", !0, !0, n)),
        ...
        function L() {
            var e = this,
                ...
                s = new $,
                l = _.call(e);
            l && !e.data.bound && (e.data.bound = !0, n[A] = a.toString(), n[P] = s.toString(), n.opacity = 1, r(i, n), e._originalImageWidth = o.width, e._originalImageHeight = o.height, e.options.enableZoom ? B.call(e, !0) : e._currentZoom = t, a.scale = e._currentZoom, n[A] = a.toString(), r(i, n), e.data.points.length ? R.call(e, e.data.points) : I.call(e), b.call(e), C.call(e))
        }
        function B(e) {
            var t, n, i, r, a = this,
                s = 0,
            ...
            a.options.enforceBoundary && (i = d.width / (e ? p.width : p.width / c), r = d.height / (e ? p.height : p.height / c), s = Math.max(i, r)),
            s >= l && (l = s + 1),
                u.min = F(s, 4),
                u.max = F(l, 4),
            e && (n = Math.max(h.width / p.width, h.height / p.height), t = null !== a.data.boundZoom ? a.data.boundZoom : n, v.call(a, t)),
                o(u)
        }
        function R(e) {
        ...
        function M(e) {
            ...
            if (o.clearRect(0, 0, n.width, n.height), n.width = i.width, n.height = i.height, r && !e) {
                var a = h(i);
                p(n, i, l(a || 0, 10))
            } else e && p(n, i, e)
        }
        function Z(e) {
            var t = this,
                ...
                b = 1;
            return y && (g = e.outputWidth, w = e.outputHeight, b = g / d),
                h.width = g,
                h.height = w,
            e.backgroundColor && (p.fillStyle = e.backgroundColor, p.fillRect(0, 0, d, m)),
            t.options.enforceBoundary || (0 > i && (f = Math.abs(i), i = 0), 0 > o && (v = Math.abs(o), o = 0), r > t._originalImageWidth && (s = t._originalImageWidth - i, d = s), a > t._originalImageHeight && (u = t._originalImageHeight - o, m = u)),
            1 !== b && (f *= b, v *= b, d *= b, m *= b),
                p.drawImage(this.elements.preview, i, o, Math.min(s, t._originalImageWidth), Math.min(u, t._originalImageHeight), f, v, d, m),
            c && (p.fillStyle = "#fff", p.globalCompositeOperation = "destination-in", p.beginPath(), p.arc(d / 2, m / 2, d / 2, 0, 2 * Math.PI, !0), p.closePath(), p.fill()),
                h
        }
        function z(e) {
            var t = e.points,
        ...
        function X(e, t) {
            ...
            if ("string" == typeof e) n = e,
                ...
                if ("undefined" == typeof e && i.data.url) return L.call(i),
                    E.call(i),
                    null;
                n = e.url,
                    o = e.points || [],
                ...
                u(n, i.elements.img, a).then(function (n) {
                    if (o.length) i.options.relative && (o = [o[0] * n.naturalWidth / 100, o[1] * n.naturalHeight / 100, o[2] * n.naturalWidth / 100, o[3] * n.naturalHeight / 100]);
                        ...
                        var r, a, s = c(n),
                            ...
                            u = l.width / l.height,
                            h = s.width / s.height;
                        h > u ? (a = s.height, r = a * u) : (r = s.width, a = r / u);
                        var p = (s.width - r) / 2,
                            d = (s.height - a) / 2,
                            m = p + r,
                            f = d + a;
        ...
        function k(e) {
            var t, i = this,
                ...
                d = p.width / p.height;
            return "viewport" === s ? (o.outputWidth = p.width, o.outputHeight = p.height) : "object" == typeof s && (s.width && s.height ? (o.outputWidth = s.width, o.outputHeight = s.height) : s.width ? (o.outputWidth = s.width, o.outputHeight = s.width / d) : s.height && (o.outputWidth = s.height * d, o.outputHeight = s.height)),
        ...
        function N(e, t) {
            if (this.element = e, this.options = n(n({}, N.defaults), t), "img" === this.element.tagName.toLowerCase()) {
                var i = this.element;
        ...
        "function" != typeof Promise && !
            function (e) {
                ...
                var u = setTimeout,
                    c = "function" == typeof setImmediate && setImmediate ||
                        function (e) {
                            u(e, 1)
                        },
                    h = Array.isArray ||
        ...
        K.parse = function (e) {
            return e.style ? K.parse(e.style[A]) : e.indexOf("matrix") > -1 || e.indexOf("none") > -1 ? K.fromMatrix(e) : K.fromString(e)
        },
        ...
        var $ = function (e) {
            if (!e || !e.style[P]) return this.x = 0,
                void(this.y = 0);
            ...
            V.fn.croppie = function (e) {
                ...
                if ("string" === t) {
                    ...
                    return "get" === e ? i.get() : "result" === e ? i.result.apply(i, n) : "bind" === e ? i.bind.apply(i, n) : this.each(function () {
                        ...
                        if (t) {
                            var i = t[e];
                            if (!V.isFunction(i)) throw "Croppie " + e + " method not found";
                            i.apply(t, n),
                            "destroy" === e && V(this).removeData("croppie")
                        }
                    })
                }
        ...
        N.defaults = {
            ...
            n(N.prototype, {
                ...
                get: function () {
                    var e = H.call(this),
                        t = e.points;
                    return this.options.relative && (t[0] /= this.elements.img.naturalWidth / 100, t[1] /= this.elements.img.naturalHeight / 100, t[2] /= this.elements.img.naturalWidth / 100, t[3] /= this.elements.img.naturalHeight / 100),
                        e
                },
                result: function (e) {
